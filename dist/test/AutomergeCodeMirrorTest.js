      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            docSet.setDoc(
              'id',
              automerge_1.change(doc, function(mdoc) {
                mdoc.text1 = new automerge_1.Text()
                mdoc.text2 = new automerge_1.Text()
              })
            )
            mutex = new Mutex_1.default()
            docSet.registerHandler(function(docId, newDoc) {
          ...
          case 1:
            ...
            strings = codeMirrors.map(function(codeMirror) {
              return codeMirror.getValue()
            })
            assert_1.default.deepStrictEqual(strings, ['TEXT1', 'TEXT2'])
            // Mimic local edit
